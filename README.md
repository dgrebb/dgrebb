...
<pre><code class="language-markdown">Total Time: 48 hrs 11 mins

Svelte             27 hrs 57 mins  ███████████───────── 55.74 %
TypeScript         8 hrs 56 mins   ████──────────────── 17.81 %
Markdown           2 hrs 47 mins   █───────────────────  5.56 %
JSON               2 hrs 2 mins    █───────────────────  4.07 %
Other              1 hr 57 mins    █───────────────────  3.92 %
Bash               1 hr 55 mins    █───────────────────  3.84 %
JavaScript         1 hr 45 mins    █───────────────────  3.52 %
CSS                1 hr 2 mins     ────────────────────  2.06 %
Docker             30 mins         ────────────────────  1.02 %
YAML               21 mins         ────────────────────  0.72 %
HTML               17 mins         ────────────────────  0.58 %
INI                10 mins         ────────────────────  0.34 %
Makefile           9 mins          ────────────────────  0.30 %
Python             8 mins          ────────────────────  0.29 %
</code></pre>
  </div>
<hr>
...
<hr>
  ...
  <br />
  <ul><li><a href=https://github.com/MicroPyramid/Django-CRM target="_blank" rel="noopener noreferrer" style="color: #A52A2A;">MicroPyramid/Django-CRM: Open Source CRM for Startups — Django REST + SvelteKit · Self-hosted · Multi-tenant · Free forever</a></li><li><a href=https://www.meziantou.net/git-worktree-managing-multiple-working-directories.htm target="_blank" rel="noopener noreferrer" style="color: #A52A2A;">Git Worktree: Managing Multiple Working Directories - Meziantou's blog</a></li><li><a href=https://edoverflow.com/2023/sveltekit-security-headers/ target="_blank" rel="noopener noreferrer" style="color: #A52A2A;">Adding security headers to your SvelteKit application | EdOverflow</a></li><li><a href=https://www.sveltest.dev/ target="_blank" rel="noopener noreferrer" style="color: #A52A2A;">Sveltest - Comprehensive Testing Suite for Svelte</a></li><li><a href=https://medium.com/@Nexumo_/sveltekit-at-scale-ssr-islands-cache-hydration-9bfa2fdc85a8 target="_blank" rel="noopener noreferrer" style="color: #A52A2A;">SvelteKit at Scale: SSR, Islands & Cache Hydration | by Nexumo | Medium</a></li></ul>
  </details>
<hr>
  <div align="center">

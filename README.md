...
<pre><code class="language-markdown">Total Time: 49 hrs 50 mins

Svelte             28 hrs 51 mins  ███████████───────── 55.11 %
TypeScript         6 hrs 37 mins   ███───────────────── 12.64 %
Markdown           4 hrs 8 mins    ██──────────────────  7.91 %
JSON               3 hrs 18 mins   █───────────────────  6.32 %
Other              2 hrs 32 mins   █───────────────────  4.84 %
Bash               2 hrs 4 mins    █───────────────────  3.95 %
JavaScript         1 hr 22 mins    █───────────────────  2.63 %
CSS                1 hr 3 mins     ────────────────────  2.01 %
Docker             40 mins         ────────────────────  1.28 %
Makefile           24 mins         ────────────────────  0.78 %
YAML               22 mins         ────────────────────  0.71 %
INI                19 mins         ────────────────────  0.61 %
HTML               12 mins         ────────────────────  0.39 %
Python             10 mins         ────────────────────  0.32 %
...
<hr>
  ...
  <br />
  <ul><li><a href=https://github.com/therohitdas/copy-env target="_blank" rel="noopener noreferrer" style="color: #A52A2A;">therohitdas/copy-env: Copy local .env files to created worktrees. Works with all coding agents.</a></li><li><a href=https://github.com/MicroPyramid/Django-CRM target="_blank" rel="noopener noreferrer" style="color: #A52A2A;">MicroPyramid/Django-CRM: Open Source CRM for Startups — Django REST + SvelteKit · Self-hosted · Multi-tenant · Free forever</a></li><li><a href=https://www.meziantou.net/git-worktree-managing-multiple-working-directories.htm target="_blank" rel="noopener noreferrer" style="color: #A52A2A;">Git Worktree: Managing Multiple Working Directories - Meziantou's blog</a></li><li><a href=https://edoverflow.com/2023/sveltekit-security-headers/ target="_blank" rel="noopener noreferrer" style="color: #A52A2A;">Adding security headers to your SvelteKit application | EdOverflow</a></li><li><a href=https://www.sveltest.dev/ target="_blank" rel="noopener noreferrer" style="color: #A52A2A;">Sveltest - Comprehensive Testing Suite for Svelte</a></li></ul>
  </details>
<hr>
  <div align="center">
